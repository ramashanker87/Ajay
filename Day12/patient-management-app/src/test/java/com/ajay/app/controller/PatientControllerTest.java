...
public class PatientControllerTest {
    ...
    public void testGetAllPatient(){
        ...
        Patient patient1 = new Patient("Ajay",21,1,"M","hospital1");
        Patient patient2 = new Patient("Shruthilaya",25,2,"F","hospital2");
        Patient patient3 = new Patient("Ravi",43,3,"M","hospital1");
    ...
    public void testUpdatePatient(){
        Patient oldPatient = new Patient("Ajay",27,2,"F","hospital2");
        Patient newPatient = new Patient("Rahul",27,2,"F","newHospital2");
