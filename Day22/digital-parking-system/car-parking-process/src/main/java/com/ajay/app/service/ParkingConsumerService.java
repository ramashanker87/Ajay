...
import com.ajay.app.module.ParkingEnd;
import com.ajay.app.module.ParkingStart;
import com.ajay.app.repository.CarRepository;
import com.ajay.app.repository.ParkingEndRepository;
import com.ajay.app.repository.ParkingStartRepository;
...
public class ParkingConsumerService {
    ...
    public void processEndRequest(String parkingNumber) {
        ...
        String responseMessage = "Response--> Parking ended for number: " + parkingNumber
                + ". Cost  " + timeInMinutes + " minutes is Rs " + end.getPrice();;
